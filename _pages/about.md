...
{% assign gsDataBaseUrl = "https://cdn.jsdelivr.net/gh/" | append: site.google_scholar_repository | append: "@latest/" %}
{% else %}
{% assign gsDataBaseUrl = "https://raw.githubusercontent.com/" | append: site.google_scholar_repository | append: "/master/" %}
{% endif %}
{% assign url = gsDataBaseUrl | append: "google-scholar-stats/gs_data_shieldsio.json" %}

I am an assistant professor (ZJU-100 Young Professor) at the School of Software Technology at Zhejiang University (ZJU). I received my Ph.D. degree from the College of Computer Science and Technology at Zhejiang University in 2025, under the supervision of Prof. [Yang Yang](http://yangy.org/). 
...
My research interests include **foundation models for structured data, agentic RL, and whole-body VLA**. I have published several papers in top tier venues, with <a href="https://scholar.google.com/citations?user=9mxdFawAAAAJ"><img src="https://img.shields.io/endpoint?url={{ url | cgi_escape }}&logo=Google%20Scholar&labelColor=f6f6f6&color=9cf&style=flat&label=citations"></a> citations on google scholar and ![Total Stars](https://img.shields.io/github/stars/sunefei?affiliations=OWNER&style=social) on github. 
